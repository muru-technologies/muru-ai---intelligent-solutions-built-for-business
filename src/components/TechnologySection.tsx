...
export default function TechnologySection() {
  ...
  return (
    <section id="technology" className="py-24 relative bg-[#07090D] border-t border-white/[0.05]">
      {/* Background radial */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12 p-6 sm:p-8 rounded-2xl glass-card border border-[#E59500]/30 bg-gradient-to-r from-[#0E1217] to-[#0A0C10] flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 text-left">
          <div className="space-y-2 max-w-3xl">
            ...
            <blockquote className="text-xl sm:text-2xl font-bold text-white tracking-tight">
          ...
          <div className="p-4 rounded-xl bg-black/60 border border-white/[0.08] flex-shrink-0">
            ...
            <div className="text-[11px] text-emerald-400 mt-1 flex items-center gap-1">
              <ShieldCheck className="w-3.5 h-3.5" /> ISO / SOC2 Compliant Topologies
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {TECH_STACK_DATA.map((cat, idx) => (
            <motion.div
              ...
              className="rounded-2xl glass-card border border-white/[0.07] p-5 text-left flex flex-col justify-between hover:border-white/[0.15] transition-colors"
            >
              <div>
        ...
        <div className="rounded-2xl glass-card border border-white/[0.08] p-6 sm:p-8 bg-black/50 text-left">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-4 mb-6 border-b border-white/[0.08]">
            ...
            <div className="flex items-center gap-2 text-xs font-mono text-emerald-400 bg-emerald-500/10 px-3 py-1 rounded-full border border-emerald-500/20">
              ...
              <span>All Systems Nominal (99.98% 30-Day SLA)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {nodes.map((node) => (
              <div
                key={node.name}
                className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.05] flex items-center justify-between"
              >
                <div>
