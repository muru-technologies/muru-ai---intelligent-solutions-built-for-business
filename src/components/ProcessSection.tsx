...
export default function ProcessSection({ onStartAudit }: ProcessSectionProps) {
  return (
    <section id="process" className="py-24 relative bg-[#07090D] border-t border-white/[0.05]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {PROCESS_DATA.map((step, idx) => (
            <motion.div
              ...
              className="rounded-2xl glass-card border border-white/[0.07] p-6 text-left hover:border-[#E59500]/40 transition-all flex flex-col justify-between group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="font-display font-black text-3xl text-zinc-700 group-hover:text-[#E59500] transition-colors">
                    {step.number}
                  </span>
        ...
        {/* Bottom Callout */}
        <div className="mt-12 p-6 rounded-2xl glass-card border border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-left">
          <div>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl font-display font-semibold text-xs sm:text-sm text-black bg-[#E59500] hover:bg-[#CC7A00] transition-colors flex items-center gap-2 flex-shrink-0 cursor-pointer"
          >
