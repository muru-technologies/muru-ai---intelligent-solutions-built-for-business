...
export default function RoiCalculator({ onBookAuditWithMetrics }: RoiCalculatorProps) {
  ...
  return (
    <section id="calculator" className="py-24 relative bg-[#07090D] border-t border-white/[0.05]">
      {/* Glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Left: Input Sliders */}
          <div className="lg:col-span-6 rounded-2xl glass-card border border-white/[0.08] p-6 sm:p-8 space-y-7 text-left">
            <h3 className="font-display text-xl font-bold text-white border-b border-white/[0.08] pb-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-mono">
                <span className="text-zinc-300 font-medium">Team Members in Operations / Support:</span>
                <span className="text-base font-bold text-[#E59500] font-sans">{teamSize} staff</span>
              </div>
              <input
                type="range"
                min={2}
                ...
                className="w-full h-2 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-[#E59500]"
              />
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-mono">
                <span className="text-zinc-300 font-medium">Monthly Inquiries / Invoices / Tasks:</span>
                <span className="text-base font-bold text-[#E59500] font-sans">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-mono">
                ...
                <span className="text-base font-bold text-[#E59500] font-sans">${hourlyRate} / hr</span>
              </div>
              <input
                type="range"
                min={10}
          ...
          <div className="lg:col-span-6 rounded-2xl glass-card border border-[#E59500]/40 p-6 sm:p-8 flex flex-col justify-between text-left relative overflow-hidden bg-gradient-to-b from-[#0A0D12] to-[#07090D] shadow-2xl shadow-[#E59500]/10">
            {/* Ambient Corner Glow */}
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="text-4xl sm:text-5xl font-display font-black text-white mt-1">
                  ${monthlyCostSavings.toLocaleString()}{' '}
                  <span className="text-base sm:text-lg font-normal text-zinc-400">/ month</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
                  <div className="flex items-center gap-1.5 text-xs text-zinc-400 font-mono mb-1">
                    <Clock className="w-3.5 h-3.5 text-[#E59500]" />
                    <span>Hours Reclaimed</span>
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-white">
                    {totalHoursSavedMonth.toLocaleString()} hrs
                  </div>
                  <div className="text-[10px] text-zinc-500 mt-0.5">Every month across team</div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-white">{resolutionRate}%</div>
                  <div className="text-[10px] text-zinc-500 mt-0.5">Average tier-1 inquiries</div>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full py-3 px-5 rounded-xl font-display font-bold text-xs sm:text-sm text-black bg-gradient-to-r from-[#E59500] via-[#F4A81E] to-[#CC7A00] hover:shadow-xl hover:shadow-[#E59500]/30 transition-all cursor-pointer flex items-center justify-center gap-2"
            >
