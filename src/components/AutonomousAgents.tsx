      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            {AUTONOMOUS_AGENTS_DATA.map((agent) => {
              ...
              return (
                <button
                  ...
                  className={`p-3.5 rounded-xl text-center transition-all duration-200 border flex flex-col items-center justify-center gap-2 cursor-pointer ${
                    isSelected
                      ? 'bg-[#E59500]/15 border-[#E59500] shadow-[0_0_20px_rgba(229,149,0,0.2)] -translate-y-1'
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-6 rounded-2xl glass-card border border-white/[0.08] p-6 sm:p-8 flex flex-col justify-between text-left">
              <div>
              ...
              <div className="mt-8 pt-4 border-t border-white/[0.06]">
                <button
                  ...
                  className="w-full py-3 px-5 rounded-xl font-display font-semibold text-xs sm:text-sm text-black bg-gradient-to-r from-[#E59500] to-[#CC7A00] hover:shadow-lg hover:shadow-[#E59500]/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="lg:col-span-6 rounded-2xl glass-card border border-white/[0.08] p-6 sm:p-8 flex flex-col justify-between text-left bg-black/60">
              <div>
                <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/[0.08]">
                  <div className="flex items-center gap-2">
                    <Terminal className="w-4 h-4 text-[#E59500]" />
                    <span className="text-xs font-mono text-zinc-300 font-bold uppercase tracking-wider">
                      Live Telemetry & Execution Log
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-mono font-medium bg-[#E59500]/15 text-[#E59500] border border-[#E59500]/30 hover:bg-[#E59500]/25 transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                  >
                    {isSimulating ? (
